...
const Paginator = ({ containerClassName, onSelectPage }) => {
  ...
  //   // console.log(`changing page ${event.selected + 1}`);
      ...
      <div className="w-full sm:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl">
        {pageCount > 0 && (
          <ReactPaginate
            ...
            nextLabel="NEXT"
            previousLabel="PREV"
            containerClassName={`${containerClassName} w-full gap-0 sm:gap-2 flex flew-wrap justify-start text-xs sm:text-sm tracking-wider`}
