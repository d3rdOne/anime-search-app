...
function App() {
  ...
  return (
    <>
      <div className="h-full min-h-lvh px-4 flex flex-col items-center  font-sans bg-gray-100 text-gray-950 dark:bg-gray-800 dark:text-gray-50 box-border trans-all-500">
        <BrowserRouter>
          <Header />
          <Routes>
